...
public class Solution {
    public static void main(String[] args) {
        ...
        Employee employee1 = new Employee(10, "Tarun Sharma", 500000);
        Employee employee2 = new Employee(20, "Aman Giri", 600000);
        Employee employee3 = new Employee(30, "Mukul Bhardwaj", 550000);
